...
def register_model_view_routes(site: Any) -> None:
    @site.app.get(
        f"/{site.prefix}/:route_id/search",
        openapi_name="Admin Model Search",
        openapi_tags=["Admin"],
    )
    ...
    @site.app.get(
        f"/{site.prefix}/:route_id",
        openapi_name="Admin Model List",
        openapi_tags=["Admin"],
    )
    ...
    @site.app.get(
        ...
        openapi_name="Admin Add Model Form",
        openapi_tags=["Admin"],
    )
    ...
    @site.app.get(
        f"/{site.prefix}/:route_id/:id/change",
        openapi_name="Admin Change Model Form",
        openapi_tags=["Admin"],
    )
