...
from ..db import cleanup_db, ensure_default_admin, ensure_sqlite_directory, setup_admin_db
...
class AdminSite:
    ...
    def _build_model_categories(
        self,
        visible_models: Dict[str, ModelAdmin],
    ...
    def _setup_templates(self):
        # provider/tortoise.py -> site -> core -> adminpanel
